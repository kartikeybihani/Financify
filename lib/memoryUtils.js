 ...
 */
async function loadUserMemoryWithTimeout(userId, query = null, timeoutMs = 2000) {
  return Promise.race([
 ...
 */
async function fetchSupermemoryProfileWithTimeout(userId, timeoutMs = 2000) {
  return Promise.race([
...
const SUPERMEMORY_FETCH_TIMEOUT_MS = 2000; // 2 seconds timeout for API calls (fast fail, graceful fallback)
