 ...
 */
async function loadUserMemoryWithTimeout(userId, query = null, timeoutMs = 5000) {
  return Promise.race([
...
const SUPERMEMORY_FETCH_TIMEOUT_MS = 5000; // 5 seconds timeout for API calls (reduced for better latency)
