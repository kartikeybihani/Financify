...
export function getClassificationPrompt({ contextHint = null } = {}) {
  const prompt = [
    ...
    "- ask_personalized: Questions about user's finances (spending, accounts, investments, affordability, advice)",
    ...
    "- needs_user_data=true: Answer requires user's actual data (spend, net worth, accounts, personal recommendations, affordability checks)",
    ...
    "  [income_takehome,income_gross,fixed_expenses,current_savings,debt_balances,credit_score,purchase_price,down_payment,timeline,location,risk_tolerance,investing_horizon,move_countries,employer_match]",
    ...
    "- If the user is describing a major plan/decision (big purchase, multi-country plan, life decision) and asks for guidance/feasibility without key numbers, set decision_risk='high', needs_clarification=true, and use info_sufficiency conservatively.",
    ...
    "- 'Should I save $5000 for a house?' -> ask_personalized (advice), intent_type:'actionable'",
    "",
    "=== CRITICAL CLASSIFICATION RULES ===",
    "1. Affordability queries are ALWAYS ask_personalized:",
    ...
    "",
    "3. Advice-seeking queries are ask_personalized:",
    ...
    "   - 'How about a 3 day camping trip to north Arizona?' → ask_personalized, needs_user_data:true, intent_type:actionable",
    "   - 'I wanna go on a Europe trip' → ask_personalized, needs_user_data:true, intent_type:actionable",
    "",
    "4. Credit card queries ALWAYS need web search:",
    "   - 'What credit card should I get?' → ask_personalized, needs_web:true, needs_user_data:true",
    "",
    "5. Stock queries REQUIRE a SPECIFIC ticker/company - general queries are ask_personalized:",
    ...
    "",
    "Field requirements:",
    "- intent: REQUIRED string (ask_personalized|stock_query|off_topic)",
    ...
    "- Travel/cost/affordability planning questions are NOT off_topic.",
    "",
    ...
    "  → required_packs: ['summary_min'], optional_packs: [], filters: {}, granularity: 'summary_level', time_range: '3_months'",
    "- 'What's my net worth?'",
