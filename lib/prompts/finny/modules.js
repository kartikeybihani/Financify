...
- Let user choose their path`;
  ...
  // Response strategy implementations
    ...
    judgment_strategy: () =>
      `Judgment approach: Lead with the number, range, or recommendation first. Use concise math, explicit assumptions when needed, and only one specific follow-up if it materially improves the advice.`,
    diagnosis_strategy: () =>
