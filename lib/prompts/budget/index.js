...
5. All limits must be whole numbers (no decimals). Set Other last = remainder so SUM = exactly $${fmt(totalBudget)}.
...
- Other = remainder so SUM = exactly $${fmt(totalBudget)}. Never create "INTERNAL_TRANSFER" or "Credit Card Payment".
