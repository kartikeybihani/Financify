 ...
 * @param {string|null} params.clarify_question - Clarification question from classification (or null)
 * @returns {Object} { needs_clarification, clarification_question }
 */
  ...
  if (decision_risk === "high" && info_sufficiency !== "sufficient") {
    return {
      ...
      clarification_question:
        clarify_question ||
        "I need more information to give you proper advice on this important decision. Can you share more details about your situation?",
    };
  }

  // Medium risk + insufficient info → conditional answer allowed (no clarification needed)
  // But we can still use clarify_question if provided for better context
