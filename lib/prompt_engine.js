  ...
  if (financialData.categoryDetails) {
    ...
    if (
      ...
      const txnLines = catDetails.transactions.map((txn) => {
        ...
        // Note: amounts are already negative for expenses, display as positive
      ...
      // Add summary totals if available (especially important for merchant queries)
      if (catDetails.total_spend !== undefined && catDetails.total_spend !== null) {
...
- NEVER use "data" or "based on your data".
