...
const DETAILED_CATEGORY_MAP = {
  ...
  GENERAL_SERVICES_PROFESSIONAL_SERVICES: {
    top: "Services",
  ...
  // LOAN_PAYMENTS - Other
  LOAN_PAYMENTS_AUTO_LOAN: { top: "Loans", sub: "Loan Payment" },
  LOAN_PAYMENTS_STUDENT_LOAN: { top: "Loans", sub: "Loan Payment" },
  LOAN_PAYMENTS_PERSONAL_LOAN: { top: "Loans", sub: "Loan Payment" },
...
const PRIMARY_CATEGORY_MAP = {
  ...
  LOAN_PAYMENTS: { top: "Loans", sub: "Loan Payment" },
  EDUCATION: { top: "Education", sub: "Education" },
};
