...
export function generateClarifyingQuestion(classification, userMessage, userContextSummary = null, memoryRefs = []) {
  ...
  const note = classification?.clarification_note && typeof classification.clarification_note === 'string'
  ...
  const personalization = hasExpenses || hasIncome ? ' Given what I know about your expenses and income,' : '';
