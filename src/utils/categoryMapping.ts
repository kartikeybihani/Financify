...
export const categoryMap: Record<string, SimplifiedCategory> = {
  // Food & Drink
 ...
 * @param plaidCategory - The original Plaid category
 * @returns Simplified category object with top and sub categories
 */
export function mapPlaidCategory(plaidCategory: string | null | undefined): SimplifiedCategory {
  if (!plaidCategory) {
